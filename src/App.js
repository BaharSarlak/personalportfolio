  ...
  return (
    <div className="bg-gradient-to-b bg-cover from-gray-500 to-gray-900
     px-8 lg:px-20 text-gray-100">
      ...
      <div className='py-20 w-full sm:w-5/6 md:w-full mx-auto text-center'>
        <h2 id='projects' className='headings'>My recent work</h2>
        <div className='md:flex gap-4 my-8'>
          <div className='my-4 p-4 md:w-1/2 lg:w-1/3 bg-gray-600 rounded-md'>
            ...
            <p>This website has been created for RuyBon Consulting engineers. The client needed a static website to represent company's history and information. This html-based website uses scss and Bootstrap to be responsive in diffferent viewports.</p>
            <div className='my-4'>
          ...
          <div className='my-4 p-4 md:w-1/2 lg:w-1/3 bg-gray-600 rounded-md'>
            ...
            <p>A React-based web application which is an alternative to Ruybon's website. This app implements yarn and libraries like reactstrap, react-bootstrap, react router, classNames and google-map-react API. </p>
            <div className='my-4'>
          ...
          <div className='my-4 p-4 md:w-1/2 lg:w-1/3 bg-gray-600 rounded-md'>
            ...
            <p>A React Native mobile application which represents nucamp bootcamp imaginary app. various react native libraris are used in this app, along with redux and expo framework.</p>
            <div className='my-4'>
              <a href='https://github.com/BaharSarlak/RuyBon-React'><button className='btn-indigo py-2 px-4 mx-2'>visit</button></a>
